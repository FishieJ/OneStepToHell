main.floors.Chap3_boss=
{
    ...
    "afterBattle": {
        "6,6": [
            ...
            "\t[黑影,N425]该死……怎么这么强……",
            "\t[hero]死吧！死吧！",
            "\t[黑影,N425]这小子的状态定然持续不了多久，暂时不要跟他硬碰，赶快结成阵法，拖住他！不出多久他必然力竭！",
            {
                "type": "playBgm",
                "name": "boss2.mp3"
            },
            ...
            "\t[熙枫,heroine]他们将狂暴的力量聚集在自己身边来增强战斗力。但是强行抽取狂暴之力必然伴生衰退之力，看看能否利用这点打败他们。",
            "\t[熙枫,heroine]小心不要把这些力量引爆了。"
        ],
        "11,7": [
            {
                "type": "addValue",
    ...
    "afterOpenDoor": {
        "6,3": [
            ...
            "\t[黑影,N425]\b[up,6,6]哈哈，已经太晚了。",
            "\t[黑影,N425]\b[up,6,6]这次你跑不掉了，熙枫。",
            "\t[hero]\b[down,hero]啥？你们在说谁？",
            "\t[黑影,N425]\b[up,6,6]小子别装傻了，这大半夜的这么努力杀怪，升级还这么快，你不会真觉得你不起眼吧？",
            "\t[黑影,N425]\b[up,6,6]不过，你就算不杀怪躲起来也是坐以待毙，我们早晚会找到你的。",
            ...
            "\t[黑影,N425]\b[down,3,3]哼，我也觉得我们早就该动手了，何必费这么大劲布一个陷阱等这小子自己走进来。",
            "\t[黑影,N425]\b[up,6,6]闭嘴，你懂个啥？我这叫养肥了杀，懂吗？",
            "\t[黑影,N425]\b[down,3,3]……不懂。",
            "\t[黑影,N425]\b[up,6,6]你个笨蛋，别忘了我们找她的目的是获得那种力量。这小子实力越强，她恢复得就越好，我们再出手抢过来赚的不就越多吗？",
            "\t[黑影,N425]\b[down,9,3]别扯那些乱七八糟的了，赶快动手，免得死于话多。",
            "\t[熙枫,heroine]（你，愿意拼命一搏吗？）",
            "\t[hero]（当然！小姐姐有办法吗？）",
            "\t[熙枫,heroine]（我可以把我的力量灌输给你，不过这对你身体的负荷极大……）",
            "\t[hero]（多大的代价我都愿意！不要犹豫了！我跟他们拼了！）",
            "\t[熙枫,heroine]（……好。我这就提前唤醒你的潜力。）",
            {
                "type": "animate",
                "name": "dark3",
                "loc": "hero",
            ...
            "\t[熙枫,heroine]（这……竟然黑化了……）",
            "\t[hero]谔谔啊啊啊啊！死吧！",
            "\t[黑影,N425]\b[down,9,3]哦？竟然用这小子的身体强行发动了血海奥义……这倒是有点麻烦了……",
            "\t[黑影,N425]\b[up,6,6]哼，自不量力。",
            "\t[黑影,N425]\b[up,6,6]你们退下，我自己来解决他，让他明白真正的血海强者的力量！",
            {
                "type": "hide",
                "loc": [
                    [
