main.floors.MT30=
{
    ...
    "firstArrive": [
        ...
        "\t[hero]不知家主找我有什么事？",
        "\t[mgz]莫逆，原本不喜修炼，境界一直处于萌新一段，今日修为突飞猛进，短短几个小时就突破至萌新九段。此等修炼速度，前所未有。",
        "\t[mgz]这背后，原因为何？",
        ...
        "\t[mgz]比起这个，吸怪物的血要严重得多。经过商议，长老团成员一致认为你修行魔道，依靠杀戮和吸血来提升自身境界，为了避免你失控，必须采取行动。",
        "\t[hero]您的意思是要我……",
        "\t[mgz]\r[red]签订契约，做我的奴隶，听从我的一切指令。",
        {
            "type": "playSound",
            "name": "boss0_pre.mp3"
        },
        ...
        "\t[hero]啊？什么？？",
        "\t[hero]这也太过分了，这不是断了我的修炼之路？",
        "\t[mgz]不错，我就直说了，必须断了你的修炼之路，不然以你的成长速度，不日便能晋升为蓝海境界，现在你能杀光粽子湖畔和泰南山的怪物，以后谁能保证你不会杀光我们来提升境界？",
        "\t[hero]我可以保证！我可以签订契约保证我永远不对你们出手！",
        "\t[mgz]很可惜，虽然我们很想这么做，但是契约的力量是有限的，等你强大到足够毁约之日，我们可没有阻止你反悔的力量。",
        "\t[hero]（可恶……）",
        "\t[mgz]你只要放弃你那魔道修行，签订契约后你名义上就是我莫家的长老，地位比普通成员高得多，如何？",
    ...
    "events": {
        "6,3": {
            ...
            "data": [
                ...
                "莫孤舟被莫逆杀害的事情迅速传遍了附近，整个莫家，甚至周围的邻居，都陷入了恐慌之中。",
                ...
                "力量……曾经的我，过着平静的生活，幻想着获取力量来感受这个世界的宏大。如今我梦想成真，却已经失去了一切。",
                "为什么会这样呢？我错在哪？我只是想要自由而已……我不想做家主的奴隶，一辈子活在他的阴影之下。",
                "莫家……虽然说不上有多喜欢，但这里毕竟是我长大的地方……",
                "……就这样草率地作别了。",
                "说起来，这一切似乎都始于那场梦……",
                "这就是真正的神仙所拥有的能力吗？仅仅是给了我一点力量，就完全改变了我的命运。",
                "吸血、杀人……做这些事情的时候我一点犹豫都没有，我还是我自己吗？",
                "我的未来，又在哪里？",
                {
                    "type": "sleep",
                    "time": 1000
