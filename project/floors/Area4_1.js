main.floors.Area4_1=
{
    ...
    "events": {
        ...
        "17,19": [
            "系统给玩家的提示：从这里开始勇士拥有主动技能\r[yellow]强击\r[white]了。开启主动技能后下一场战斗自动使用，需要消耗\r[blue]魔法\r[white]，目前只能依靠拾取魔法结晶（蓝色方块）来回复魔法。",
            {
                "type": "if",
                "condition": "flag:hard < 3",
                "true": [
                    "\r[yellow]强击\r[white]这个主动技能可以对怪物造成额外伤害，虽然攻击力提升之后能够造成更多的额外伤害，不过实际上往往还是在勇士攻击力和防御力都比较低的时候使用收益更大。另外，这个伤害是\r[yellow]技能伤害\r[white]，不会被闪避、重甲等属性减免，对这类怪使用技能，或许会有奇效！"
                ],
                "false": [
