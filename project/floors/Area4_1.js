        ...
        "21,19": [
            {
                ...
                "true": [
                    "系统给玩家的提示：\n本区开始出现带有领域伤害的怪物，勇士只要经过他们身边就会受到伤害。\n面对这类怪物时，一个常用的技巧是“轻点”，也就是不进行移动直接获取面前的物品。操作方法为，面向物品，按空格或者双击勇士。",
                    "在很多其他魔塔里这个技巧也有效。",
                    "现在就来试试用“轻点”获取牌子上方的绿宝石吧。"
                ],
                "false": [
                    "系统给玩家的提示：本区域由大地图构成，浏览地图（PgUp/PgDown）时按Z键可以进行总览。"
                ]
            }
        ],
        "17,19": [
            "系统给玩家的提示：从这里开始勇士拥有主动技能“强击”了。开启主动技能后每场战斗都需要消耗魔法，目前只能依靠拾取魔法结晶（蓝色方块）来回复魔法。",
            {
                "type": "if",
                "condition": "flag:hard < 3",
                "true": [
                    "“强击”这个主动技能可以对怪物造成额外伤害，虽然攻击力提升之后能够造成更多的额外伤害，不过实际上还是在勇士攻击力和防御力都比较低的时候使用收益更大。"
                ],
                "false": []
            }
        ]
