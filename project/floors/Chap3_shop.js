main.floors.Chap3_shop=
{
    ...
    "events": {
        ...
        "6,8": [
            "\t[系统提示]几乎所有商品以及金币在本章结束后都会被清空并换算成分数，唯一的例外是\r[yellow]防净化盾牌\r[white]。不是刷分的话请不要省钱。",
            "\t[系统提示]另外，如果感觉游戏变得十分艰难，不妨换一个天赋选择试试。"
        ],
        "12,6": {
            "trigger": null,
            "enable": false,
    ...
    [151,103,100146,122,100146,103,129,103,100146,126,100146,103,151],
