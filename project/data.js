		...
		"levelUp": [
			...
			},
			{
				...
				"action": [
					...
					"升级！生命、生命上限+50，攻击+1，防御+1，护盾+2",
					"\t[hero]这……就是升级的感觉吗……想不到我莫逆竟然也有踏入萌新二段的一天！",
					"\t[hero]而且升级竟然如此顺利、如此简单！要是我打完这花园里的莱姆，捡完这里的各种宝石，恐怕能踏入萌新三段、甚至更高的境界吧……",
					"\t[hero]继续前进吧。"
				]
			},
			{
			...
			},
			{
				...
				"action": [
					...
					"升级！生命、生命上限+1600，攻击+20，防御+20，护盾+32",
					"【次级冲锋】变强了。"
				]
			},
			{
			...
			},
			{
				...
				"action": [
					...
					},
					{
						"type": "setValue",
						"name": "status:hpmax",
						"value": "status:hpmax+6000"
					},
					{
						"type": "setValue",
						"name": "status:hp",
						"value": "status:hp+6000"
					},
					{
						"type": "setValue",
						"name": "status:manamax",
						"value": "status:manamax+20"
					},
					{
						"type": "setValue",
						"name": "status:mana",
					...
					},
					{
						"type": "setValue",
						"name": "status:atk",
						"value": "status:atk+120"
					},
					{
						"type": "setValue",
						"name": "status:def",
						"value": "status:def+120"
					},
					{
						"type": "setValue",
						"name": "status:mdef",
						"value": "status:mdef+150"
					},
					...
					"\t[hero]（晋升为蓝海二阶了，试试看能不能把那神秘黑影叫出来）",
					"\t[hero]喂？你好？",
					"\t[黑影,unknown]……我感觉还不是很好。",
					"\t[hero]你到底是谁？你从哪来的？",
					"\t[黑影,unknown]嗯……我被好多强者围攻，几乎陨落，只剩一点意识在虚空中游荡，然后遇到了一个愿意接纳我的宿主……",
					"\t[hero]什么？我什么时候愿意接纳你了？",
					"\t[hero]喂？喂？",
					"\t[hero]……",
			...
			},
			{
				...
				"action": [
					...
					},
					{
						"type": "setValue",
						"name": "status:atk",
						"value": "status:atk+160"
					},
					{
						"type": "setValue",
						"name": "status:def",
						"value": "status:def+160"
					},
					{
						"type": "setValue",
						"name": "status:mdef",
						"value": "status:mdef+200"
					},
					"升级！生命、生命上限+8000，魔法、魔法上限+20，攻击+160，防御+160，护盾+200",
					{
						"type": "sleep",
						"time": 500
					},
					"\t[hero]（又升了一级，大概能唤醒那黑影了吧）",
					"\t[hero]喂！在吗？",
					"\t[黑影,unknown]……又有什么事？",
					"\t[hero]我仔细思考之后有好多疑问……",
					"\t[hero]首先我想确认，是不是我的境界越高，你恢复得越快？",
					"\t[黑影,unknown]你悟性还挺不错。毕竟我现在寄宿在你这里，你的力量能帮助我恢复。",
					"\t[hero]我昨晚做了那个梦以后就发现自己升级非常快，你应该就是在那个时候寄宿在我脑海里的吧？",
					"\t[hero]但是我梦中出现的明明是个红衣服的怪物，他给我表演了一个极其厉害的招式，然后我就醒了。",
					"\t[黑影,unknown]红衣服的怪物？且不说我从来不穿红衣服也不是怪物，就算我是，当时的我只是一缕残魂，看上去也绝对不可能是这个样子。",
					"\t[黑影,unknown]毕竟，直到现在，我还无法凝聚出我的样貌。",
					"\t[hero]……好吧。",
					"\t[hero]你寄宿之后，因为我境界太低，你陷入了沉睡，所以你应该是在我晋升蓝海阶以后才苏醒……我从莫家跑到这里，其实你在背后暗中操控了吧？",
					"\t[黑影,unknown]没错，其实你晋入蓝海之前我已经能感知到外面发生的事情了，只是无法与你交流而已。本来计划是等你晋入蓝海阶再跟你说离开莫家的，却不料你那家主……真是个奇葩。你杀了他之后精神十分恍惚，我只好操控你跑到这里了。",
					"\t[黑影,unknown]虽然手刃亲人不合常理，但你那家主实在是咄咄逼人，何况你杀了他也解救了那么多跟他签订了奴隶契约的长老们，算是做了件好事吧。更不用提你对那些禁言家规的不满……",
					"\t[hero]……",
					"\t[hero]既然你操控我跑到这里，你是不是对这里很了解？",
					"\t[黑影,unknown]有一些了解。你升级需要杀死大量的生物，总不能到处杀人吧？而这里尽是些被遗弃的鬼魂野兽。",
					"\t[hero]我的力量到底是怎么来的？你现在这么虚弱，怎么能让我升级这么快？",
					"\t[黑影,unknown]这就涉及到我的血海奥义了……原理很复杂，总之我就是有这种能力，很厉害吧？",
					"\t[hero]呃……你刚才说的血海奥义是什么？",
					"\t[hero]喂？",
			...
			},
			{
				...
				"action": [
					...
					},
					{
						"type": "setValue",
						"name": "status:hpmax",
						"value": "status:hpmax+10000"
					},
					{
						"type": "setValue",
						"name": "status:hp",
						"value": "status:hp+10000"
					},
					{
						"type": "setValue",
						"name": "status:manamax",
					...
					},
					{
						"type": "setValue",
						"name": "status:atk",
						"value": "status:atk+200"
					},
					{
						"type": "setValue",
						"name": "status:def",
						"value": "status:def+200"
					},
					{
						"type": "setValue",
						"name": "status:mdef",
						"value": "status:mdef+250"
					},
					"升级！生命、生命上限+10000，魔法、魔法上限+20，攻击+200，防御+200，护盾+250",
					{
						"type": "sleep",
						"time": 500
					},
					"\t[hero]喂！在吗！",
					"\t[少女,heroine]……",
					"\t[hero]竟然能凝聚出样貌了。我还以为会是个中年大妈或者老奶奶，没想到……",
					"\t[少女,heroine]就算是那些年龄上讲能当你太奶奶的人，往往也是少女外貌呢。",
					"\t[熙枫,heroine]不过我可没比你大多少，我叫熙枫。",
					"\t[hero]啊？真的是小姐姐？",
					"\t[熙枫,heroine]我可是记得你不久之前还声称从来没想过接纳我呢？",
					"\t[hero]呃，这个……我的意思是，我做梦都想不到有这种好事，所以怎么可能想过接纳你，对吧……",
					"\t[熙枫,heroine]我记得你一开始可不是这个态度啊。",
					"\t[hero]……",
					{
						"type": "sleep",
						"time": 500
					},
					"\t[熙枫,heroine]话说回来，你接纳我的残魂应该不是偶然。你是不是整天做着变成盖世强者的白日梦？",
					"\t[hero]……",
					"\t[熙枫,heroine]那就是了。血海级别的残魂，对于你这种境界的人来讲，就是你梦寐以求的力量来源。",
					"\t[hero]血海级别……到底有多强？",
					"\t[熙枫,heroine]你应该知道世间有四大等级，萌新，蓝海，红海，最后就是血海……萌新和蓝海都细分为九个小等级，而红海则分为低阶、中阶、高阶、巅峰四个阶段，再之后就是血海境界了。",
					"\t[hero]听起来也没什么了不起的嘛……",
					"\t[熙枫,heroine]蓝海阶位在一些偏僻地方是比较少见的，像你那个莫家，蓝海一阶就是最强者。到了大势力管辖的区域，蓝海境界的人则算是中坚力量，红海境界才有资格做长老，而势力首领基本上是红海巅峰的级别。",
					"\t[熙枫,heroine]至于血海境界的人，已经强大到足以脱离这里，前往天外的世界去探寻了。",
					"\t[hero]天外的世界？",
					"\t[熙枫,heroine]那是真正意义上广阔无垠的地方，甚至有超越血海境界的强者存在，那里远远比这个世界要精彩，所以能达到血海境界的人，基本都不会留在这里。",
					"\t[hero]我现在升级这么快，感觉到达血海境界也没什么难度嘛。",
					"\t[熙枫,heroine]嗯嗯，很好。现在你也知道我会随着你境界的提升而不断恢复，等你成为血海强者我就能凝聚肉身脱离你了，到时我有神秘奖励给你作为报答。",
					"\t[熙枫,heroine]抓紧时间修炼，我得继续休息了，你加油哦。",
					"\t[hero]……"
				]
			},
			{
				...
				"action": [
					...
					},
					{
						"type": "setValue",
						"name": "status:mdef",
						"value": "status:mdef+360"
					},
					"升级！生命、生命上限+15000，魔法、魔法上限+20，攻击+300，防御+300，护盾+360",
					{
						"type": "setValue",
					...
					"\t[hero]原来升级还能扩大灯光范围的？？",
					"\t[熙枫,heroine]毕竟你的力量变强的同时，我也在变强啊。",
					"\t[hero]小姐姐现在应该感觉好了不少了吧？",
					"\t[熙枫,heroine]别得意，你距离血海境界还远呢。",
					"\t[hero]你之前说等我成就血海境界，你要奖励我，具体是什么？",
					"\t[熙枫,heroine]嗯……还没想好……",
					"\t[hero]要不我帮你想一个，小姐姐，我想……",
					"\t[熙枫,heroine]不行，这个我说了算。",
					"\t[hero]唉，我在这冰天雪地里面这么辛苦地修炼，竟然连一个小小的请求都做不了主……",
					"\t[熙枫,heroine]得了便宜还卖乖，别忘了你升级这么快的原因。你放心吧，我不会亏待你的。"
				]
			},
			{
				"need": "10000",
				...
				"action": [
					...
					},
					{
						"type": "setValue",
						"name": "status:hpmax",
						"value": "status:hpmax+20000"
					},
					{
						"type": "setValue",
						"name": "status:hp",
						"value": "status:hp+20000"
					},
					{
						"type": "setValue",
						"name": "status:manamax",
					...
					},
					{
						"type": "setValue",
						"name": "status:atk",
						"value": "status:atk+600"
					},
					{
						"type": "setValue",
						"name": "status:def",
						"value": "status:def+600"
					},
					{
						"type": "setValue",
						"name": "status:mdef",
						"value": "status:mdef+720"
					},
					"升级！生命、生命上限+20000，魔法、魔法上限+20，攻击+600，防御+600，护盾+720",
					{
						"type": "setValue",
						"name": "flag:lightRadius",
						"value": "flag:lightRadius+15"
					...
					"\t[hero]升级……再升级……一下子升级太快了也有点迷茫了，我为什么要升级呢？",
					"\t[hero]我能不能就这样带着小姐姐隐居起来，闲着没事的时候就跟小姐姐聊天，这不也挺幸福的嘛……",
					"\t[熙枫,heroine]但是那些围攻我的人会找上来带走我的，而你根本无力阻止。",
					"\t[hero]……你这话也太真实了吧。",
					"\t[熙枫,heroine]想调戏我你还嫩着呢。真是的，遇到这么宝贵的修炼机会还不珍惜，净想些奇怪的东西。",
					"\t[hero]可是我在想……遇到这么宝贵的小姐姐我就不应该珍惜吗？",
					"\t[熙枫,heroine]……",
					{
						"type": "sleep",
						"time": 1000
					},
					"\t[熙枫,heroine]如果你真的想带着我过上平静幸福的生活，那强大的力量是必不可少的。",
					"\t[hero]……好吧我知道了。"
				]
			},
			{
				...
				"action": [
					...
					"升级！生命、生命上限+30000，魔法、魔法上限+50，攻击+1000，防御+1000，护盾+1200",
					{
						"type": "setValue",
						"name": "flag:lightRadius",
						"value": "flag:lightRadius+15"
					...
					"\t[熙枫,heroine]原来你还会说点好听的话。 ",
					"\t[hero]我是真的好奇啊，别说是漂亮的小姐姐，哪怕就是油腻的中年大叔，也不会无缘无故就被人围攻至死吧？",
					"\t[熙枫,heroine]……利益。为了利益什么都能做得出来。漂亮并不算什么优势。",
					"\t[hero]那些人很希望看到小姐姐吃瘪的样子吧？如果小姐姐让自己变丑一些，比如变成老太婆的样子，是不是……",
					"\t[熙枫,heroine]要是事情有那么简单就好了……现在的你还是不要想那么多了，赶快修炼，时间很紧迫。",
					"\t[hero]什么意思？",
					"\t[熙枫,heroine]那些人应该知道我这缕残魂逃走了，估计正在到处追捕我。他们全部都是血海境界，以你现在的实力，被他们找到了绝无还手之力。",
			...
			},
			{
				...
				"action": [
					...
					},
					{
						"type": "setValue",
						"name": "status:hpmax",
						"value": "status:hpmax+50000"
					},
					{
						"type": "setValue",
						"name": "status:hp",
						"value": "status:hp+50000"
					},
					{
						"type": "setValue",
						"name": "status:manamax",
					...
					},
					{
						"type": "setValue",
						"name": "status:atk",
						"value": "status:atk+1500"
					},
					{
						"type": "setValue",
						"name": "status:def",
						"value": "status:def+1500"
					},
					{
						"type": "setValue",
						"name": "status:mdef",
						"value": "status:mdef+1800"
					},
					"升级！生命、生命上限+50000，魔法、魔法上限+50，攻击+1500，防御+1500，护盾+1800",
					{
						"type": "setValue",
						"name": "flag:lightRadius",
						"value": "flag:lightRadius+15"
					...
					"\t[hero]蓝海八阶了，还差一步就到蓝海之中的最高阶位了。",
					"\t[熙枫,heroine]虽然我觉得你突破是理所应当的，不过还是恭喜你吧。",
					"\t[熙枫,heroine]不过别高兴太早，蓝海九阶和红海低阶之间的差距比较大，这是一个质的变化，不是所有生物都能够通过慢慢积累而晋升为红海阶位的。",
					"\t[熙枫,heroine]也正是因为蓝海九阶和红海低阶之间的差距极大，所以中间还有一个被称为蓝海巅峰的等级，用来描述那些远远强于普通蓝海九阶却还没达到红海境界的生物。",
					"\t[熙枫,heroine]而红海巅峰与血海之间的差距甚至更大，中间的等级则被称为半步血海。",
					"\t[hero]差距再大又如何，有小姐姐在我一定能迈过去！",
					"\t[熙枫,heroine]你说话倒是越来越好听了。",
					"\t[hero]呃，难道这样不好吗？",
					"\t[熙枫,heroine]……呆瓜。"
				]
			},
			{
				...
				"action": [
					...
					},
					{
						"type": "setValue",
						"name": "status:atk",
						"value": "status:atk+2000"
					},
					{
						"type": "setValue",
						"name": "status:def",
						"value": "status:def+2000"
					},
					{
						"type": "setValue",
						"name": "status:mdef",
						"value": "status:mdef+2400"
					},
					"升级！生命、生命上限+100000，魔法、魔法上限+50，攻击+2000，防御+2000，护盾+2400",
					{
						"type": "setValue",
						"name": "flag:lightRadius",
						"value": "flag:lightRadius+15"
					...
					"\t[hero]蓝海九大阶位，我如今已经处于顶峰了……",
					"\t[hero]小姐姐给我讲些有趣的事情吧……比如我一直很好奇小姐姐的身世，比我大不了多少的血海强者，总感觉跟我不像是同一个世界的人。",
					"\t[熙枫,heroine]这个世界很大……你理解不了的东西有很多。",
					"\t[hero]确实很多……比如直到现在我还不明白境界名称的由来，萌新我还能理解，就是很“萌”（可爱）的“新人”，那为什么蓝海阶位被称为蓝海，红海阶位叫红海，蓝海和红海差别到底在哪？",
					"\t[熙枫,heroine]你现在已经蓝海九阶了，你觉得蓝海和萌新的差别在哪？",
					"\t[hero]除了各方面战斗能力更强之外……好像也没太大的区别。",
					"\t[熙枫,heroine]其实，蓝海这个名称的由来十分古老，关于其具体出处也是说法不一。甚至，在那天外的世界，境界划分体系和这个世界并不一样，在那里，蓝海境界并不叫蓝海。",
					"\t[熙枫,heroine]按照我的理解，蓝海境界和萌新境界最大的区别，便是对于魔法的掌握，也就是俗称的“蓝”。",
					"\t[熙枫,heroine]晋入蓝海境界，才能够掌握技能，运用魔法值，使自己在战斗中更加强大。",
					"\t[熙枫,heroine]但与此同时，并非所有生物都能够掌握技能，像你之前已经遇到过很多没有掌握特殊技能的野兽，它们之所以被称为蓝海，只不过是因为它们的战斗力与人类的蓝海强者相仿而已。所以，你大概能理解为什么在天外的世界，境界划分并没有使用“蓝海”这个名字了吧？",
					"\t[hero]明白了。他们是不是也没有使用“红海”“血海”这些名字？",
					"\t[熙枫,heroine]没错。",
					{
						"type": "sleep",
						"time": 500
					...
					"\t[hero]那么，蓝海和红海的区别呢？",
					"\t[熙枫,heroine]刚才已经说过，蓝海注重对魔法的掌控，而红海则是注重对生命的掌控。红海境界的强者，能够直接操控生命值，比如有一种著名的红海技能，能够直接扣掉你一半的生命值。",
					"\t[hero]这……这么恐怖？",
					"\t[熙枫,heroine]当然是有条件限制的，而且反制手段也是有的。",
					"\t[熙枫,heroine]而血海，则是生命操控能力达到极致之后的境界。绝大多数血海以下的生物，在真正的血海强者面前，都如同蝼蚁一般，生或者死，皆在对方的一念之间。",
					"\t[hero]（我昨天做梦梦到的那个“夹爆”，难道就是血海境界的技能？一瞬之间生命就归为1，简直太恐怖了……）",
					"\t[hero]红海和血海境界这么强，真是有点难以想象我该如何晋入那等境界……毕竟现在我达到蓝海九阶，已经感觉到自己距离下一个等级很遥远了……",
					"\t[熙枫,heroine]这点你放心好了，有我在的话只要慢慢积累总能突破的。",
