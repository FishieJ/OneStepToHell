		...
		"enemys": {
			...
			"_data": {
				...
				"special": {
					...
					"_data": "特殊属性\n\n0:无,1:先攻,2:魔攻,3:坚固,4:2连击,\n5:3连击,6:n连击,7:破甲,8:反击,9:净化,\n10:模仿,11:吸血,12:中毒,13:衰弱,14:霜寒,\n15:领域,16:夹击,17:仇恨,18:阻击,19:自爆,\n20:无敌,21:退化,22:固伤,23:重生,24:激光,25:光环,26:支援,27:捕捉\n99:闪避,100:穿刺,101:夹爆,102:上位威压,103:强击,104:斩杀,105:重甲,115:怒意狂击\n106:寒霜之足,107:冰封禁制,108:霜寒爆发,109:寒冰护甲\n110:光明,111:黑暗,112:迅捷,113:迟钝,114:智障\n120:魔免,121:重伤,122:盛宴,123:竭心,124:血怨,125:血域,126:苦痛\n130:审判之剑,131:无敌斩,132:混乱,133:伯化,134:域爆,135:阻爆,136:射爆,137:超模仿,138、139、140:范围防御、生命、攻击光环,141:中子束\n多个属性例如用[1,4,11]表示先攻2连击吸血"
				},
				"value": {
					"_leaf": true,
					"_type": "textarea",
					"_data": "特殊属性的数值\n如：破甲倍数；领域/阻激/激光怪的伤害值；吸血怪的吸血比例；光环怪增加生命的比例；反伤比例；上位威压等级"
				},
				"zoneSquare": {
					"_leaf": true,
					"_type": "checkbox",
				...
				"range": {
					...
					"_data": "领域伤害/范围光环的范围；不加默认为1；斩杀生效百分比"
				},
				"notBomb": {
					"_leaf": true,
					"_type": "checkbox",
				...
				"atkValue": {
					...
					"_data": "退化时勇士下降的攻击力点数；光环怪增加攻击的比例；强击倍数"
				},
				"defValue": {
					"_leaf": true,
					"_type": "textarea",
					"_range": "thiseval==~~thiseval||thiseval==null",
					"_data": "退化时勇士下降的防御力点数；光环怪增加防御的比例；重甲/闪避比例"
				},
				"damage": {
					"_leaf": true,
					"_type": "textarea",
					"_range": "thiseval==~~thiseval||thiseval==null",
					"_data": "战前扣血的点数；冰霜之足或冰封禁制的每回合伤害；"
				},
				"x": {
					"_leaf": true,
					"_type": "textarea",
